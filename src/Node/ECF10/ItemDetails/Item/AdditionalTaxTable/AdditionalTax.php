...
use Angle\ECF\Node\ECF10\ItemDetails\Item\AdditionalTaxTable\AdditionalTax\AdditionalTaxRate;
use Angle\ECF\Node\ECF10\ItemDetails\Item\AdditionalTaxTable\AdditionalTax\SpecificConsumptionTaxAmount;
use Angle\ECF\Node\ECF10\ItemDetails\Item\AdditionalTaxTable\AdditionalTax\AdValoremConsumptionTaxAmount;
use Angle\ECF\Node\ECF10\ItemDetails\Item\AdditionalTaxTable\AdditionalTax\OtherAdditionalTaxes;
use DOMDocument;
use DOMElement;
use DOMNode;
use DOMText;
...
class AdditionalTax extends ECFNode
{
    ...
    public function setSpecificConsumptionTaxAmount(?SpecificConsumptionTaxAmount $amount): self
    {
        $this->specificConsumptionTaxAmount = $amount;
        return $this;
    }
    ...
    public function setAdValoremConsumptionTaxAmount(?AdValoremConsumptionTaxAmount $amount): self
    {
        $this->adValoremConsumptionTaxAmount = $amount;
        return $this;
    }
    ...
    public function setOtherAdditionalTaxes(?OtherAdditionalTaxes $taxes): self
    {
        $this->otherAdditionalTaxes = $taxes;
        return $this;
    }
}