...
/**
 * @method static PageTotalTaxableAmount createFromDOMNode(DOMNode $node)
 */
class PageTotalTaxableAmount extends ECFNode
{
    #########################
    ##        PRESETS      ##
    #########################

    const NODE_NAME = "SubtotalMontoGravadoPagina";
