...
/**
 * @method static PageAdditionalTaxAmount createFromDOMNode(DOMNode $node)
 */
class PageAdditionalTaxAmount extends ECFNode
{
    #########################
    ##        PRESETS      ##
    #########################

    const NODE_NAME = "SubtotalImpuestoAdicionalPagina";
