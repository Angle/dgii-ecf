...
/**
 * @method static PageNonBillableAmount createFromDOMNode(DOMNode $node)
 */
class PageNonBillableAmount extends ECFNode
{
    #########################
    ##        PRESETS      ##
    #########################

    const NODE_NAME = "SubtotalMontoNoFacturablePagina";
