...
/**
 * @method static OtherCurrencyTotalTaxableAmount createFromDOMNode(DOMNode $node)
 */
class OtherCurrencyTotalTaxableAmount extends ECFNode
{
    #########################
    ##        PRESETS      ##
    #########################

    const NODE_NAME = "MontoGravadoTotalOtraMoneda";
