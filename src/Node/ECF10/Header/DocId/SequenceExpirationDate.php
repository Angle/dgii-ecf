...
/**
 * @method static SequenceExpirationDate createFromDOMNode(DOMNode $node)
 */
class SequenceExpirationDate extends ECFNode
{
    #########################
    ##        PRESETS      ##
    #########################

    const NODE_NAME = "FechaVencimientoSecuencia";
