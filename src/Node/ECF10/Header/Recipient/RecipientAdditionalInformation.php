...
/**
 * @method static RecipientAdditionalInformation createFromDOMNode(DOMNode $node)
 */
class RecipientAdditionalInformation extends ECFNode
{
    #########################
    ##        PRESETS      ##
    #########################

    const NODE_NAME = "InformacionAdicionalComprador";
