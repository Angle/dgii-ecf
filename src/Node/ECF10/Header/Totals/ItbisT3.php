...
/**
 * @method static ItbisT3 createFromDOMNode(DOMNode $node)
 */
class ItbisT3 extends ECFNode
{
    #########################
    ##        PRESETS      ##
    #########################

    const NODE_NAME = "ITBIS3";
    ...
    public static function newWithValue($value): ItbisT3
    {
        $itbisT3 = new ItbisT3([]);
        $itbisT3->setValue($value);
