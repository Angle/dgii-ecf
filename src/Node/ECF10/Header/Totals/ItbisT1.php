...
/**
 * @method static ItbisT1 createFromDOMNode(DOMNode $node)
 */
class ItbisT1 extends ECFNode
{
    #########################
    ##        PRESETS      ##
    #########################

    const NODE_NAME = "ITBIS1";
    ...
    public static function newWithValue($value): ItbisT1
    {
        $itbisT1 = new ItbisT1([]);
        $itbisT1->setValue($value);
